var provinceList = [
    {name:'北京市', cityList:[
        {name:'北京市市辖区', areaList:['东城区','西城区','崇文区','宣武区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区']}
    ]},
    {name:'上海市', cityList:[
        {name:'上海市市辖区', areaList:['黄浦区', '徐汇区', '长宁区', '静安区', '普陀区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '青浦区', '奉贤区', '崇明县']},
        {name:'上海市郊县', areaList:['全区']}
    ]},
    {name:'天津市', cityList:[
        {name:'天津市市辖区', areaList:['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '滨海新区', '宁河区', '静海区', '蓟县']},
        {name:'天津市郊县', areaList:['全区']}
    ]},
    {name:'重庆市', cityList:[
        {name:'重庆市市辖区', areaList:['万州区', '涪陵区', '渝中区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '梁平县', '城口县', '丰都县', '垫江县', '武隆县', '忠县', '开县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县']},
        {name:'重庆市郊县', areaList:['全区']},
    ]},    
    {name:'河北省', cityList:[
    ...
    {name:'广东省', cityList:[
        ...
        {name:'深圳市', areaList:['罗湖区','福田区','南山区','宝安区','龙岗区','盐田区','龙华新区','光明新区','坪山新区','大鹏新区']},
    ...
    {name:'香港特别行政区', cityList:[
        {name:'中西区', areaList:['全区']},
        {name:'湾仔区', areaList:['全区']},
        {name:'东区', areaList:['全区']},
        {name:'南区', areaList:['全区']},
        {name:'油尖旺区', areaList:['全区']},
        {name:'深水埗区', areaList:['全区']},
        {name:'九龙城区', areaList:['全区']},
        {name:'黄大仙区', areaList:['全区']},
        {name:'观塘区', areaList:['全区']},
        {name:'荃湾区', areaList:['全区']},
        {name:'屯门区', areaList:['全区']},
        {name:'元朗区', areaList:['全区']},
        {name:'北区', areaList:['全区']},
        {name:'大埔区', areaList:['全区']},
        {name:'西贡区', areaList:['全区']},
        {name:'沙田区', areaList:['全区']},
        {name:'葵青区', areaList:['全区']},
        {name:'离岛区', areaList:['全区']}
    ]},
    {name:'澳门特别行政区', cityList:[
        {name:'花地玛堂区', areaList:['全区']},
        {name:'花王堂区', areaList:['全区']},
        {name:'望德堂区', areaList:['全区']},
        {name:'大堂区', areaList:['全区']},
        {name:'风顺堂区', areaList:['全区']},
        {name:'嘉模堂区', areaList:['全区']},
        {name:'路凼填海区', areaList:['全区']},
        {name:'圣方济各堂区', areaList:['全区']},
    ]},
    {name:'台湾省', cityList:[
        {name:'台湾', areaList:['全区']}
    ]}
